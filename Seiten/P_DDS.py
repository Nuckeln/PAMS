...
def expanderFigGesamtPicks(df):
        ...
        def figPicksGesamtnachTagUndVerfügbarkeit(df,unterteilen,tabelle,sel_barmode):
            ...
            try:
                ...
                return st.warning('Keine Daten gepflegt bitte die Vl06o Updaten mit dem Plant DE55')
            ...
            fig.update_xaxes(showticklabels=True)
            # Create the faceted plot
            fig.update_layout(showlegend=True, title_text="Verfügbare Picks", title_x=0.5, title_font_size=20, title_font_family="Montserrat", title_font_color="#0F2B63", legend_title_font_color="#0F2B63", legend_title_font_family="Montserrat", legend_title_font_size=14, legend_font_size=12, legend_font_family="Montserrat", legend_font_color="#0F2B63", legend_orientation="h", legend=dict(x=0.5, y=-0.2), margin=dict(l=0, r=0, t=50, b=0), height=800)
            #updatedate each in facet_col
            if unterteilen != None:
            # Create the faceted plot
                #updatedate each in facet_col
                ...
                fig.update_xaxes(showticklabels=True, row=1, col=4)
                ###### umbauen
                fig.update_layout(title_text="Picks Gesamt nach Verfügbarkeit", title_x=0.5, title_font_size=20, title_font_family="Montserrat", title_font_color="#0F2B63", legend_title_font_color="#0F2B63", legend_title_font_family="Montserrat", legend_title_font_size=14, legend_font_size=12, legend_font_family="Montserrat", legend_font_color="#0F2B63", legend_orientation="h", legend=dict(x=0.5, y=-0.2), margin=dict(l=0, r=0, t=50, b=0), height=800)
                fig.update_layout(font_family="Montserrat",font_color="#0F2B63",title_font_family="Montserrat",title_font_color="#0F2B63")
            fig.update_layout(
                    annotations=[
                        {"x": x, "y": total * 1.05, "text": str(total), "showarrow": False}
