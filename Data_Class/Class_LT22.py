...
#     pass
    ...
    def go():
        print("START")
        dflt22 = pd.read_excel('/Users/martinwolf/Desktop/SuperDepot Python/Data/lt22.XLSX', 0, header=0)
        dfStammdaten = pd.read_excel('/Users/martinwolf/Desktop/SuperDepot Python/Data/Stammdaten.xlsx', 0, header=0)
        dfLabel = pd.read_csv('/Users/martinwolf/Desktop/SuperDepot Python/Data/Label.csv', sep=",")
        dfUser = pd.read_excel('/Users/martinwolf/Desktop/SuperDepot Python/Data/user.xlsx', 0, header=0, index_col=0)
